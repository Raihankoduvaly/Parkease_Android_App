    ...
    inner class FloorAdapter(private val floors: List<Floor>) :
        ...
        inner class SlotAdapter(private val slots: List<ParkingSlot>) :
            ...
            override fun onBindViewHolder(holder: SlotViewHolder, position: Int) {
                ...
                // Placeholder logic for availability (customize as needed)
                val isAvailable = position % 2 == 0 // Every even index is available
                ...
                holder.itemView.setOnClickListener {
                    // Handle slot selection (could add your logic here)
                }
            }
