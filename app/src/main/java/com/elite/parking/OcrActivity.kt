    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        captureButton.setOnClickListener {
            try {
                ...
                Log.e("OcrActivity", "Error capturing photo", e)
        ...
        refresh.setOnClickListener {
            ...
            textView.text = "Capture Image again"
        ...
        recognizer.process(image)
            .addOnSuccessListener { visionText ->
                if (!visionText.text.isNullOrBlank()) {
                    ...
                    textView.text = extractedText // You can use numberPlate here if you want to refine it
                    lnrRefresh.visibility = View.VISIBLE
                    btnSubmit.visibility = View.VISIBLE
                } else {
                    textView.text = ""
                    Toast.makeText(this, "No valid text detected. Try again.", Toast.LENGTH_LONG).show()
                    lnrRefresh.visibility = View.GONE
                    btnSubmit.visibility = View.GONE
                }
            }
