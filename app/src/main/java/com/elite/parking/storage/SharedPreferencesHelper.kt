...
class SharedPreferencesHelper(context: Context) {
    ...
    fun storeLoginResponse(loginResponse: LoginResponse) {
        ...
        Log.d("SharedPreferencesHelper", "Storing login response: $loginResponseJson")  // Log this for debugging
    ...
    fun getLoginResponse(): LoginResponse? {
        ...
        Log.d("SharedPreferencesHelper", "Retrieved login response: $loginResponseJson")  // Log for debugging
